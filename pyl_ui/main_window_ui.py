...
""))
    ...
    def createMenuActions(self):
        ...
        self.menuGraphicsAction = QtGui.QAction("Graphics", self.menuBar)
        ...
        self.menuBar.addAction(self.menuGraphicsAction)
    ...
    def connectMenuActions(self):
        ...
        self.menuGraphicsAction.triggered.connect(self._MainWindow.MenuGetGraphicsAppData)
